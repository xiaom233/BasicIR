...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = 'datasets/ImageSR/DF2K/DF2K_train_HR_sub'
    lmdb_path = 'datasets/ImageSR/DF2K/DF2K_train_HR_sub.lmdb'
    ...
    # LRx4 images
    folder_path = 'datasets/ImageSR/DF2K/DF2K_train_LR_bicubic/X4_sub'
    lmdb_path = 'datasets/ImageSR/DF2K/DF2K_train_LR_bicubic_X4_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
