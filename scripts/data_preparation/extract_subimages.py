...
def main():
    ...
    # HR images
    opt['input_folder'] = '/mnt/petrelfs/puyuandong/Low_level_vision/BasicIR/datasets/ImageSR/DF2K/DF2K_HR'
    opt['save_folder'] = '/mnt/petrelfs/puyuandong/Low_level_vision/BasicIR/datasets/ImageSR/DF2K/DF2K_train_HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    opt['input_folder'] = '/mnt/petrelfs/puyuandong/Low_level_vision/BasicIR/datasets/ImageSR/DF2K/DF2K_Bicubic/X4'
    opt['save_folder'] = '/mnt/petrelfs/puyuandong/Low_level_vision/BasicIR/datasets/ImageSR/DF2K/DF2K_train_LR_bicubic/X4_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
